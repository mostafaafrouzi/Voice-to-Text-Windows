...
from .theme import create_app_icon, get_check_icon_path
...
class SystemTrayManager(QSystemTrayIcon):
    """
    مدیریت آیکون سیستم‌تری ویندوز با منوی دسترسی سریع و تم هماهنگ.
    """
    ...
    def update_theme(self):
        ...
        check_path = get_check_icon_path()

        self.menu.setFont(get_font(12))
